...
<template>
  <aside
    id="sidebar-menu"
    class="bg-gray-50 border-r fixed left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar"
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
      <ul class="space-y-2 font-medium">
        <li>
          <a
            ...
            class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gradient-to-r from-indigo-100 to-rose-100"
          >
            <svg
        ...
        <li>
          <a
            ...
            class="flex items-center p-2 text-gray-900 rounded-lg e hover:bg-gradient-to-r from-indigo-100 to-rose-100"
          >
            <svg
      ...
      <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
        <li>
          <span class="ml-1 text-sm">ACCOUNT</span>
        </li>
        <li>
          <a
            href="#"
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap"
              >Hey, {{ username ? username : "Anonymous" }}!</span
            >
          </a>
        </li>
        <li>
